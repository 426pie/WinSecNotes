...
The good thing about these Windows API functions, is that most of them are very simple. They look something like this (in x86_64 assembly)
...
So basically, we just need to recreate our own version of the above function, and make the Syscall Service Number variable. There is one Syscall Service Number per System Call. See [this Github page](https://github.com/j00ru/windows-syscalls/tree/master) for reference (SSN may be different depending on Windows OS verison).
